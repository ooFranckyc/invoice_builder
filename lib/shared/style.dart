...
class AppTextStyle {
  ...
  static TextStyle textStyle0({Color? color, FontStyle? style, FontWeight? weight}) => TextStyle(
      //fontFamily: AppStrings.fontName,
  ...
  static TextStyle textStyle1({Color? color, FontStyle? style, FontWeight? weight}) => TextStyle(
      //fontFamily: AppStrings.fontName,
  ...
  static TextStyle textStyle2({Color? color, FontStyle? style, FontWeight? weight}) => TextStyle(
      //fontFamily: AppStrings.fontName,
  ...
  static TextStyle textStyle3({Color? color, FontStyle? style, FontWeight? weight}) => TextStyle(
      //fontFamily: AppStrings.fontName,
